...
export const createTable = (columnsArray, dataArray,tableId) => {
    ...
    !tableId
        ...
        throw new Error('Para correta execução,precisamos de um array com as colunas,outro com as informações das linhas e também o id do elemento tabela selecionado!');
    }
...
function createTableHeader(tableReference, columnsArray){
    //<table></table> || <table> <thead> </thead> <tbody> </tbody> </table>
    ...
    for (const [itemIndex, tableItem] of tableItems.entries()) {
      ...
      for(const tableColumn of columnsArray){
         ...
         tableRow.innerHTML += /*html*/ `<td class='text-center'>${formatFn(
          tableItem[tableColumn.accessor])}</td>`;
        }
